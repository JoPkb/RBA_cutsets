...
def itertools_product(listofcutsets, objective="biomass_components"):
    i = 1
    good_cutsets = []
...
if __name__ == "__main__":
    cutsets_path = sys.argv[1]
    reaction_subsets = sys.argv[2]
    ...
    good_cutsets = itertools_product(listofcutsets_original_id)
